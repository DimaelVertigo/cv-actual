  ...
  function s(o, u) {
    ...
    (function (window, document) {
      ...
      var SVGInjector = function () {
        ...
        setFallbackClassNames = function setFallbackClassNames(element, symbolId, classNames) {
        ...
        removeFallbackClassNames = function removeFallbackClassNames(element, symbolId, fallbackClassNames) {
        ...
        suffixIdReferencesInStyles = function suffixIdReferencesInStyles(styleTag, suffix, svg, name) {
          var numRefs = 0;
        ...
        suffixIdReferences = function suffixIdReferences(svg, suffix) {
          var defs = [{
            def: "linearGradient",
            attrs: ["fill", "stroke"]
          }, {
        ...
        copyAttributes = function copyAttributes(svgElemSource, svgElemTarget, attributesToIgnore) {
          var curAttr;
        ...
        cloneSymbolAsSVG = function cloneSymbolAsSVG(svgSymbol) {
        ...
        doPrefixStyleTags = function doPrefixStyleTags(styleTag, injectCount, svg) {
          ...
          var regex,
              ...
              newContent = "",
              selectorArr,
              prefixSelector = function prefixSelector(elem, idx, arr) {
        ...
        getClassList = function getClassList(svgToCheck) {
          var curClassAttr = svgToCheck.getAttribute("class");
          return curClassAttr ? curClassAttr.trim().split(" ") : [];
        };
        getSpriteIdFromClass = function getSpriteIdFromClass(element) {
        ...
        cloneSvg = function cloneSvg(config, sourceSvg, fragId) {
          var svgElem,
              newSVG = null,
              viewBox,
              viewBoxAttr,
        ...
        queueRequest = function queueRequest(fileName, fragId, callback, el) {
        ...
        processRequestQueue = function processRequestQueue(url) {
        ...
        loadSvg = function loadSvg(onElementInjectedCallback, url, el) {
        ...
        writeDefaultClass = function writeDefaultClass(removeStylesClass) {
        ...
        replaceNoSVGClass = function replaceNoSVGClass(element, noSVGClassName, hasSvgSupport) {
          if (hasSvgSupport) {
        ...
        onLoadSVG = function onLoadSVG(url, fragmentId, onElementInjectedCallback, el, name) {
        ...
        uniqueClasses = function uniqueClasses(list) {
          list = list.split(" ");
          var hash = {};
          var i = list.length;
          var out = [];
        ...
        svgElemSetClassName = function svgElemSetClassName(el, newClassNames) {
        ...
        setRootLevelElem = function setRootLevelElem(type, svg, el, fragmentId, addDefault) {
          var elemId = fragmentId ? fragmentId + "-" : "",
              existingElem;
        ...
        addRootLevelElem = function addRootLevelElem(type, svg, text, id, insertBefore) {
          var newElem,
              existingElem = svg.querySelector(type);
